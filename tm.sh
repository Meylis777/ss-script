...
#   НУ ЛАДНО, ПИЗДИЙ, ПИЗДИЙ КОД... ВСЕ ЧТО ТЕБЕ НУЖНО ПРЯМО ПОД ЭТИМ @xamov_...
#===============================================================================
...
${Purple}|${Font_default}${Red}Telegram:${Yellow} @adamzatt ${Purple}            ${Font_default}${Purple}|${Font_default}
